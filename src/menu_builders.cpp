...
MENU_TEMPLATE_ITEM MainMenuTemplate[] =
    {
        ...
        {MNTT_IT, IDS_MENU_CMD_DEFAULT_SHELL, MNTS_I | MNTS_A, CM_DEFAULT_SHELL, -1, 0, NULL},
        ...
        {MNTT_IT, IDS_MENU_HELP_REPORTBUG, MNTS_B | MNTS_I | MNTS_A, CM_REPORTBUG, -1, 0, NULL},
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, 0, -1, 0, NULL},
...
MENU_TEMPLATE_ITEM FindMenuTemplate[] =
    {
        ...
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, 0, -1, 0, NULL},
        {MNTT_IT, IDS_FFMENU_FILES_SAVE_RESULTS, MNTS_B | MNTS_I | MNTS_A, CM_FIND_SAVE_RESULTS, -1, 0, NULL},
        {MNTT_IT, IDS_FFMENU_FILES_LOAD_RESULTS, MNTS_B | MNTS_I | MNTS_A, CM_FIND_LOAD_RESULTS, -1, 0, NULL},
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, 0, -1, 0, NULL},
