...
// [endgame:11] Wide twin used by the core implementation. NOT part of the
// frozen v107 plugin ABI - plugins keep MSGBOXEX_PARAMS; the wide shape
// becomes the ABI's own at v108 (task 23).
struct MSGBOXEX_PARAMSW
{
    HWND HParent;
    const wchar_t* Text;
